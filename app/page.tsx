      ...
      if (typeof window !== 'undefined' && window.Pi) {
        ...
        window.Pi = {
            ...
            createPayment: async (data: any, callbacks: any) => {
                if(callbacks.onReadyForServerApproval) setTimeout(() => callbacks.onReadyForServerApproval("mock-payment-id-999"), 1000);
            },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button 
                ...
                disabled={piSdkState === "loading"}
                className={`text-xs border border-yellow-500/30 rounded-full px-4 h-9 transition-all duration-300 font-semibold z-50 relative ${user ? 'bg-yellow-500/20 text-yellow-400' : 'bg-transparent text-yellow-500 hover:bg-yellow-500/10'} ${piSdkState === "loading" ? "opacity-50 cursor-not-allowed" : ""}`}
              >
